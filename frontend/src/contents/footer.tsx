                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex space-x-5 pt-2">
                            {[
                                { name: 'GitHub Project', url: 'https://github.com/yeghor/Tarot' },
                                { name: 'GitHub Yeghor', url: 'https://github.com/yeghor' },
                                { name: 'GitHub Viky', url: 'https://github.com/cyjiky' }
                            ].map((item) => (
                                <a 
                                    key={item.name} 
                                    href={item.url}
                                    ...
                                    className="w-10 h-10 flex items-center justify-center rounded-full bg-violet-100 text-violet-600 hover:bg-violet-600 hover:text-white transition-all duration-300"
                                >
